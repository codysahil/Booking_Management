...
@section('content')
    ...
    <div class="relative overflow-hidden" style="background: linear-gradient(135deg, #0f766e 0%, #14b8a6 50%, #06b6d4 100%);">
        <!-- Decorative circles -->
    ...
    <!-- Main Content -->
    <div style="background: linear-gradient(180deg, #f0fdfa 0%, #ffffff 100%);" class="min-h-screen">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <form action="{{ route('booking.select-beds') }}" method="POST" id="bed-selection-form">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl overflow-hidden" style="border: 1px solid rgba(0,0,0,0.05);">
                            <!-- Card Header -->
                            <div class="px-6 py-5 border-b" style="background: linear-gradient(90deg, #f0fdfa 0%, #ccfbf1 100%);">
                                        ...
                                        @if($isAvailable)
                                            <label class="cursor-pointer group">
                                                ...
                                                <div class="relative rounded-2xl p-5 text-center transition-all duration-300 border-2 border-gray-100
                                                    peer-checked:border-cyan-500 peer-checked:shadow-lg peer-checked:shadow-cyan-100
                                                    hover:border-cyan-200 hover:shadow-md group-hover:-translate-y-1"
                                                    ...
                                                    <div class="absolute top-3 right-3 w-6 h-6 rounded-full border-2 border-gray-200 flex items-center justify-center
                                                        peer-checked:border-cyan-500 transition-all duration-300"
                                                        style="background: white;">
                                                        <div class="w-3 h-3 rounded-full scale-0 peer-checked:scale-100 transition-transform duration-300" style="background: linear-gradient(135deg, #14b8a6, #0f766e);"></div>
                                                    </div>
                                                    ...
                                                    <div class="mt-2 mb-3">
                                                        <span class="text-2xl font-bold" style="color: #0f766e;">₹{{ number_format($bed->monthly_rent) }}</span>
                        ...
                        <div class="mt-6 bg-white rounded-3xl shadow-xl p-6" style="border: 1px solid rgba(0,0,0,0.05);">
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div class="flex items-center gap-5">
                                    <div class="w-16 h-16 rounded-2xl flex items-center justify-center" style="background: linear-gradient(135deg, #ccfbf1 0%, #99f6e4 100%);">
                                        <span id="selected-count" class="text-3xl font-bold" style="color: #0f766e;">0</span>
                                    </div>
                                    <div>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl overflow-hidden" style="border: 1px solid rgba(0,0,0,0.05);">
                            <div class="px-5 py-4" style="background: linear-gradient(135deg, #0f766e 0%, #14b8a6 100%);">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl p-6" style="border: 1px solid rgba(0,0,0,0.05);">
                            <h3 class="font-bold text-gray-900 text-lg mb-5 flex items-center">
                                <span class="w-8 h-8 rounded-lg mr-3 flex items-center justify-center" style="background: linear-gradient(135deg, #ccfbf1, #99f6e4);">
                                    <svg class="w-4 h-4" style="color: #0f766e;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="space-y-3">
                                @php
                                    $amenities = [
                                        ...
                                        ['icon' => 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z', 'name' => 'Attached Bathroom', 'color' => '#14b8a6'],
                                    ];
                                @endphp
                                @foreach($amenities as $amenity)
                                    <div class="flex items-center p-3 rounded-xl" style="background: #f0fdfa;">
                        ...
                        <!-- Help Card -->
                        <div class="rounded-3xl p-6" style="background: linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 100%); border: 1px solid #99f6e4;">
                            <div class="flex items-start gap-4">
                                <div class="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #14b8a6, #0f766e);">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('contact') }}" class="inline-flex items-center font-semibold text-sm transition-colors" style="color: #0f766e;">
                                        Contact Us
