            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <div class="space-y-4 text-gray-600 leading-relaxed">
                        <p>
                            {{ setting('hostel_name') }} was born from a simple yet powerful vision: to create a home away from home where women can feel safe, supported, and inspired to pursue their dreams.
                        </p>
                        <p>
                        ...
                        <p>
                            Every aspect of {{ setting('hostel_name') }} is designed with women's needs in mind, from our 24/7 security to our community events that foster meaningful connections and personal growth.
                        </p>
                    </div>
                </div>
                <div class="relative">
